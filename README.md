...
| `bcn_answer_city_query` | Execute a ready BCN city-query plan and return deterministic `answer_text`, `answer_markdown`, warning `caveats`, informational `execution_notes`, citation guidance, selected resource metadata, and the raw final result. |
