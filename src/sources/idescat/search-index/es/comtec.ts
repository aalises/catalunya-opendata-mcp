...
const entries: IdescatSearchIndexEntry[] = [
  {
    "statistics_id": "comtec",
    "node_id": "22177",
    "table_id": "22",
    "label": "Exportaciones e importaciones. Por grupos de productos, países y medio de transporte",
    "ancestor_labels": {
  ...
  },
  {
    ...
    "node_id": "22179",
    "table_id": "57",
    "label": "Exportaciones e importaciones. Por grupos de productos, continentes y áreas geográficas y medio de transporte",
    "ancestor_labels": {
      "statistic": "Comercio con el extranjero según contenido tecnológico",
