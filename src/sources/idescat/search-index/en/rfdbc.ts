...
const entries: IdescatSearchIndexEntry[] = [
  {
    ...
    "node_id": "13301",
    "table_id": "14148",
    "label": "RFDB and RFDB per inhabitant. 2019 Benchmark Revision",
    "ancestor_labels": {
  ...
  },
  {
    ...
    "node_id": "13302",
    "table_id": "21197",
    "label": "Components of the RFDB: main resources (+) and uses (−). 2019 Benchmark Revision",
    "ancestor_labels": {
      "statistic": "Territorial Gross Disposable Household Income",
  ...
  },
  {
    ...
    "node_id": "21181",
    "table_id": "25017",
    "label": "RFDB and RFDB per inhabitant. 2024 Benchmark Revision",
    "ancestor_labels": {
      "statistic": "Territorial Gross Disposable Household Income",
  ...
  },
  {
    ...
    "node_id": "21182",
    "table_id": "25018",
    "label": "Components of the RFDB: main resources (+) and uses (−). 2024 Benchmark Revision",
    "ancestor_labels": {
      "statistic": "Territorial Gross Disposable Household Income",
