...
const entries: IdescatSearchIndexEntry[] = [
  {
    ...
    "node_id": "22177",
    "table_id": "22",
    "label": "Exports and imports. By groups of products, countries and means of transport",
    "ancestor_labels": {
  ...
  },
  {
    ...
    "node_id": "22179",
    "table_id": "57",
    "label": "Exports and imports. By groups of products, continents and geographical areas and means of transport",
    "ancestor_labels": {
      "statistic": "Foreign Trade according to Technological Content",
