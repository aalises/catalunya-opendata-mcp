...
const entries: IdescatSearchIndexEntry[] = [
  {
    ...
    "node_id": "22177",
    "table_id": "22",
    "label": "Exportacions i importacions. Per grups de productes, països i mitjà de transport",
    "ancestor_labels": {
  ...
  },
  {
    ...
    "node_id": "22179",
    "table_id": "57",
    "label": "Exportacions i importacions. Per grups de productes, continents i àrees geogràfiques i mitjà de transport",
    "ancestor_labels": {
      "statistic": "Comerç amb l'estranger segons contingut tecnològic",
